...
import type { OrderShortResponse, OrderStatus, PaymentStatus, PaymentMethod, UpdateOrderStatusRequest } from "@/api";
    ...
    <Card className="w-full mb-6">
      <CardHeader className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
        <CardTitle className="text-lg font-semibold">
          Заказ #{order.id} — <span className="text-gray-600">{formatOrderDate(order.orderDate)}</span>
        </CardTitle>
